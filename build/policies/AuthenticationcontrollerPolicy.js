...
*     08/02/2018: 	Error handling                 	    Daroya, Carlos Adrian A.
*
*
*
...
*     File purpose:
*     Error handling file for authentication process
*/
                    ...
                    case 'password':
                         res.status(400).send({
                              error: `Password provided failed to match the following rules:
                                        ...
                                        <br>
                                        2. It must be at least 8 characters in length and not greater than 20 characters`
                         })
                         break
                    default:
                         res.status(400).send({
